...
import ecommerse from "../media/ecommerse.png";
import todolist from "../media/todolist.gif";
import moviedb from "../media/moviedb.gif";
  ...
  const listItems = [
    {
      ...
      detail: "Movie Database landing page",
      stack: "REACT-REACTHOOK-BOOTSTRAP-AXIOS-REACTROUTERDOM",
    ...
    },
    {
      ...
      detail:
        "Todo List app for the users to add their To do's daily. They can filter their To do's by clicking the filter button to show all to do's or completed to do's.",
    ...
    {
      imgSrc: ecommerseImg,
      title: "E commerse webstyle",
      detail:
        "E commerse webstyle with google signup. Primary working on design pattern and optimization .Currently working",
      stack: "REACT-REACTHOOK-REACTROUTER-REDUX-FIREBASE-GOOGLEAUTH-RESELECT",
    ...
    ,
    {
      ...
      title: "BANGKOK TIME",
      detail:
        "News App, where the users can pick the news by month and year. The app uses NewYork Time API for the resources.",
    ...
    },
    {
      ...
      gitHubSrc:
        "https://github.com/mcguyvor/doglist-for-react-router-practice-with-navlink-nav",
    },
    {
      imgSrc: vendingGif,
      title: "Vending machine",
      detail:
        "Vending machine app provided three differents items for the user to pick",
      stack: "REACT-REACT ROUTER-REDUX",
      pageSrc: "https://vendingmachinereactrouterredux.firebaseapp.com",
      gitHubSrc:
        "https://github.com/mcguyvor/vending-machine-react-routing-redux-prac",
    },
    {
      imgSrc: todoReduxGif,
      title: "Todo List with redux form",
    ...
    },
    {
      ...
      detail:
        "Restaurant manager web app, enable users to add or remove products and order products from the website.",
    ...
    },
    {
      ...
      title: "Pokedex",
      detail:
        "My very first React web app, this pokedex game calculates the scores for each player by its experience",
      stack: "REACT",
          ...
          return (
            <div className="card p-2 sha threed col-xs-12">
              <img
                style={{ width: "100%" }}
                src={idx.imgSrc}
                className="shadow-lg rounded card-img-top p-2"
              />
              <div className="card-body">
                <h5 className="card-title title font-weight-bold text-monospace">
                  <u>{idx.title}</u>
                </h5>
                <p className="card-text">{idx.detail}</p>
                <p className="card-text font-weight-bold text-center">
                  <small>
                    <strong>{idx.stack}</strong>
                  </small>
                </p>
                <div className="d-flex justify-content-center">
                  {idx.pageSrc !== null ? (
                    <a
                      className="btn btn-primary rounded-pill mr-2 shadow btn-change"
                      href={idx.pageSrc}
                      role="button"
                      target="_blank"
                    >
                  ...
                  <a
                    className="btn btn-outline-primary rounded-pill shadow btn-change"
                    href={idx.gitHubSrc}
                    role="button"
                    target="_blank"
                  >
